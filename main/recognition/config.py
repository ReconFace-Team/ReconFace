...
OV_PERFORMANCE_HINT = "LATENCY"  # o "LATENCY"

# Rutas a modelos IR (XML) descargados con OMZ
...
# Confianzas mínimas
DET_MIN_CONFIDENCE = 0.60  # detector
LMK_INPUT_SIZE = (48, 48)
REC_INPUT_SIZE = (112, 112)  # ArcFace

# Color esperado por modelos OMV (IR de ArcFace/Detector/LMK esperan BGR)
